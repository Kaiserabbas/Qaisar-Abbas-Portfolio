        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <br />
              <br />With a dynamic background in both software development and agriculture, I bring a unique blend of technical expertise and industry experience. As a dedicated Software Developer, I've developed extensive knowledge in:
              <br />
              <br />
              <i>
                <b className="tech">Sofware Development:</b> Object-Oriented Programming, Pair-Programming, Test-driven development
              </i>
              <br />
              <i>
                 <b className="tech">Frontend:</b> Front End Design, HTML5, CSS, Javascript/React, Redux, API, Frameworks, Bootstrap 
              </i>
              <br />
              <i>
                 <b className="tech">Backend:</b> Database-PostgreSQL, Ruby on Rails, Unit Testing, Deployment, Maintenance
              </i>
              <br />
              <i>
                 <b className="tech">Test Driven Development:</b> RSpec, Capybara and Jest 
              </i>
              <br />
              <i>
                 <b className="tech">Tools & Methods:</b>  Git, Github
              </i>
              <br />
              <br />
